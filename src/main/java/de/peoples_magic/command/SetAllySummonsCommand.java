...
public class SetAllySummonsCommand {
    ...
    private int exec(ServerPlayer player, int value){
        player.setData(ModAttachments.SUMMON_ALLY_SUMMONS, value);
        PacketDistributor.sendToPlayer(player, new SummonAllySummonsPayload(value));
