...
public class SummonAllyExpertise extends BOMExpertise {


    public SummonAllyExpertise(SpellArea spell_area, Player player, SpellTile tile, int z_index) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick, int adj_x, int adj_y, float zoom) {
        ...
        draw_expertise(guiGraphics, this.knowledge == 2, first_x, root_y, zoom, COOLDOWN_TEXTURE,
                mouseX, mouseY, List.of(Component.literal("Army")));
        draw_expertise(guiGraphics, this.knowledge == 3, second_x, root_y, zoom, SWORD_TEXTURE,
                mouseX, mouseY, List.of(Component.literal("Might")));
        draw_expertise(guiGraphics, this.knowledge == 4, third_x, root_y, zoom, HORSE_TEXTURE,
                mouseX, mouseY, List.of(Component.literal("Steed")));
    }
    ...
    public AttachmentType<Integer> get_attachment() {
        return ModAttachments.SUMMON_ALLY_KNOWLEDGE.get();
    }
